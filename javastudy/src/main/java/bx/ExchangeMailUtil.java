...
public class ExchangeMailUtil {
	...
	/**
	 * 测试接收收件箱里的邮件，并打印主题等信息
	 * @throws Exception
	 */
	private static void testReadInbox() throws Exception {
		// Outlook Web Access路径通常为/EWS/exchange.asmx
		ExchangeMailUtil mailUtil = new ExchangeMailUtil("https://mail.oa.bx/ews/exchange.asmx",
				"madepeng@oa.bx", "P@chunyan1");
		// 接收邮件
		ArrayList<EmailMessage> mails = mailUtil.receive(1);
